export const ADD_AUCTION_MUTATION = `
    mutation AddAuction( $logo: String!, $sports: String!, $auction_name: String!, $date: String!, $time: String!, $base_bit: Int!, $bit_increse_by: Int!, $max_player: Int!, $min_player: Int!, $user_id: Int!)
    {
        addAuction( logo: $logo, sports: $sports, auction_name: $auction_name, date: $date, time: $time, base_bit: $base_bit, bit_increse_by: $bit_increse_by, max_player: $max_player, min_player: $min_player, user_id: $user_id )
    }
`;
