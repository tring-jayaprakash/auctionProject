...
const NewAuction = () => {
    ...
    const { auction, setAuction, teamAuction, setTeamAuction, playerAuction, setPlayerAuction } = useContext(GlobalContext)
                ...
                <div id='New-inner-div'>
                    ...
                    <div id='New-body-div'>
                        <form onSubmit={handleSubmit(onSubmit)} id='new-form'>
                            ...
                            <div className='from-sub-div'>
                                <button type="submit" id="login_btn" style={{ cursor: "pointer", fontWeight: "bolder" }}><b> {auction ? "Update" : "Submit"}</b></button>
                                {
