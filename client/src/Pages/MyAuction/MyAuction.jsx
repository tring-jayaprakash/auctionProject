    ...
    import { GET_AUCTION_BY_USER, GET_AUCTION_BY_USER_ID, GET_TEAM_BY_AUCTION_ID } from '../../../graphql/query/userQuery';
        ...
        useEffect(() => {
            const fetchAuctions = async () => {
                try {
                    ...
                    console.log(data.getAuctionByUser);
                    
                    setAuctionData(data.getAuctionByUser);
                } catch (error) {
